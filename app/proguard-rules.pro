...
-keep class com.neex.music.models.PersistQueue { *; }
-keep class com.neex.music.models.PersistPlayerState { *; }
-keep class com.neex.music.models.QueueData { *; }
-keep class com.neex.music.models.QueueType { *; }
-keep class com.neex.music.playback.queues.** { *; }
