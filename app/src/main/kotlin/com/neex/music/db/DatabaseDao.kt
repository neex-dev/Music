...
import com.neex.music.constants.AlbumSortType
import com.neex.music.constants.ArtistSongSortType
import com.neex.music.constants.ArtistSortType
import com.neex.music.constants.PlaylistSortType
import com.neex.music.constants.SongSortType
import com.neex.music.db.entities.Album
import com.neex.music.db.entities.AlbumArtistMap
import com.neex.music.db.entities.AlbumEntity
import com.neex.music.db.entities.PlayCountEntity
import com.neex.music.db.entities.AlbumWithSongs
import com.neex.music.db.entities.Artist
import com.neex.music.db.entities.ArtistEntity
import com.neex.music.db.entities.Event
import com.neex.music.db.entities.EventWithSong
...
import com.neex.music.db.entities.PlaylistEntity
...
import com.neex.music.db.entities.SetVideoIdEntity
import com.neex.music.db.entities.Song
import com.neex.music.db.entities.SongAlbumMap
import com.neex.music.db.entities.SongArtistMap
import com.neex.music.db.entities.SongEntity
import com.neex.music.db.entities.SongWithStats
import com.neex.music.extensions.reversed
import com.neex.music.extensions.toSQLiteQuery
import com.neex.music.models.MediaMetadata
import com.neex.music.models.toMediaMetadata
import com.neex.music.ui.utils.resize
import com.viza.music.models.SongOfflineContent
...
interface DatabaseDao {
    ...
    @Transaction
    @Query("SELECT Song.*, contentLength FROM Song JOIN format ON song.id = format.id WHERE contentLength IS NOT NULL AND totalPlayTime > 0 ORDER BY Song.ROWID DESC")
    fun songsOfflineContent(): Flow<List<SongOfflineContent>>
